        ...
        <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
            ...
            <div class="col-4 py-3 px-x1">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end ps-0 order-0 order-md-1 mb-2 mb-md-0 text-600">${{ $item['quantity'] * $item['product']->price }}</div>
                </div>
            </div>
        </div>
        @empty
        ...
        <div class="row fw-bold gx-x1 mx-0">
            ...
            <div class="col px-0">
                <div class="row gx-x1 mx-50">
                    <div class="col-md-8 py-2 px-x1 d-none d-md-block text-center">{{ count($cartItems) }} (items)</div>
                    <div class="col-12 col-md-4  py-2 px-x1">${{$totalPrice}}</div>
                </div>
            </div>
        </div>
    </div>
