    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row flex-between-center">
                <div class="col-md">
                    <h5 class="mb-2 mb-md-0">Submit</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.admin.products.store') }}">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input class="form-control" id="product-title" type="text" name="title"
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input class="form-control" id="product-description" type="text" name="description"
                                :value="{{ old('description') }}" placeholder="{{ __('Description') }}" required />
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <input class="form-control" id="product-price" type="text" name="price"
                    ...
                    <div class="card-body">
                        <form class="dropzone dropzone-multiple p-0" id="dropzoneMultipleFileUpload"
                            data-dropzone="data-dropzone" action="#!" data-options='{"acceptedFiles":"image/*"}'>
                            <div class="fallback">
                                <input name="file" type="file" multiple="multiple" />
                            </div>
                            <div class="dz-message" data-dz-message="data-dz-message">
                                <img class="me-2" src="../../../assets/img/icons/cloud-upload.svg" width="25"
                                    alt="" />
            ...
            <div class="card-body">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <button class="btn btn-primary" type="submit" role="button">Submit product</button>
                    </div>
                </div>
            </div>
        </div>
