...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('dashboard/public/assets/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('dashboard/public/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('dashboard/public/assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('dashboard/public/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('dashboard/public/assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage"
        content="{{ asset('dashboard/public/assets/img/favicons/mstile-150x150.png') }}">
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2"
                                src="{{ asset('dashboard/public/assets/img/icons/spot-illustrations/falcon.png') }}"
                                ...
                                <ul class="nav collapse show" id="e-commerce">
                                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#product"
                                        ...
                                        <ul class="nav collapse show" id="product">
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ asset('dashboard/public/app/e-commerce/product/product-list.html') }}">
                                                    <div class="d-flex align-items-center"><span
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ asset('dashboard/public/app/e-commerce/product/product-grid.html') }}">
                                                    <div class="d-flex align-items-center"><span
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ asset('dashboard/public/app/e-commerce/product/product-details.html') }}">
                                                    <div class="d-flex align-items-center"><span
                                            ...
                                            <li class="nav-item"><a class="nav-link active"
                                                    href="{{ asset('dashboard/public/app/e-commerce/product/add-product.html') }}">
                                                    <div class="d-flex align-items-center"><span
                                    ...
                                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#orders"
                                        ...
                                        <ul class="nav collapse" id="orders">
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ asset('dashboard/public/app/e-commerce/orders/order-list.html') }}">
                                                    <div class="d-flex align-items-center"><span
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ asset('dashboard/public/app/e-commerce/orders/order-details.html') }}">
                                                    <div class="d-flex align-items-center"><span
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                                ...
                                <div class="avatar avatar-xl">
                                    <img class="rounded-circle"
                                        src="{{ asset('dashboard/public/assets/img/team/3-thumb.png') }}"
                                        alt="" />
