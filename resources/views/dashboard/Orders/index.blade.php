    ...
    <table class="table mb-0">
        <thead class="bg-200">
            <tr>
                ...
                <th class="text-black dark__text-white align-middle">Address</th>
                <th class="text-black dark__text-white align-middle">Phone number</th>
        ...
        <tbody id="bulk-select-body">
            ...
            <tr>
                ...
                <td class="align-middle">
                    <pre>{{ $order->building_number }}{{ $order->street_name }}{{ $order->city }}{{ $order->postcode }}
                    </pre>
                </td>
